...
{
    private TileEntitySmeltingFurnace furnace;
    ...
    public void detectAndSendChanges()
    {
        ...
        this.lastBurnTime = this.furnace.smeltingFurnaceBurnTime;
    ...
    public void updateProgressBar(int par1, int par2)
    {
        ...
        if (par1 == 1)
        {
            this.furnace.smeltingFurnaceBurnTime = par2;
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (TileEntitySmeltingFurnace.isItemFuel(itemstack1))
                {
